...
\begin{center}
    \includegraphics[width=14cm]{uml/odometer_serial_robustness.pdf}
...
\begin{center}
    \includegraphics[width=14cm]{uml/odometer_encoder_robustness.pdf}
...
\inputVHDL{hardware/uart.vhdl}

\subsection{SerialController}
\subsubsection{hardware/serial\_controller.vhdl}
\inputVHDL{hardware/serial_controller.vhdl}
...
\inputC{software/swhw_interface.h}

\subsubsection{software/swhw\_interface.c}
\inputC{software/swhw_interface.c}

\subsubsection{hardware/hwsw\_interface.vhdl}
\inputVHDL{hardware/hwsw_interface.vhdl}

\subsubsection{hardware/interrupt\_controller.vhdl}
\inputVHDL{hardware/interrupt_controller.vhdl}
